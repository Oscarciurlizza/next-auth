          ...
          <section className="mt-8">
            <div className="space-y-5">
              ...
              <button
                ...
                className="group relative flex w-full justify-center rounded-md border-transparent bg-gradient-to-r from-rose-100 to-teal-100 border border-black py-2.5 px-4 text-sm font-normal text-black hover:bg-bluered-100 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                  <Google />
                </span>
